 	...
 	<div id="nm-uploadfile" class="nm-uploader-area">
	    <div id="container_buttons">
	        <div class="btn_center">
	            <a id="select-button" class="button" href="javascript:;" style="background-color: <?php echo nm_uploader_button_bgcolor(); ?>; color: <?php echo $this -> get_option('_button_txt_color'); ?>">
...
<script>
    ...
    uploader_filemanager = new plupload.Uploader({
	    ...
	    // Flash settings
		flash_swf_url 		: '<?php echo $nmfilemanager -> plugin_meta['url']?>/js/plupload-2.1.2/js/uploader/Moxie.swf',
		// Silverlight settings
		silverlight_xap_url : '<?php echo $nmfilemanager -> plugin_meta['url']?>/js/plupload-2.1.2/js/uploader/Moxie.xap',
		...
		init: {
			...
			FileUploaded: function(up, file, info){
				...
				if(ext == 'png' || ext == 'gif' || ext == 'jpg' || ext == 'jpeg'){
					...
					$filelist_DIV.find('#u_i_c_' + file.id).find('.u_i_c_thumb').append('<span style="display:none" id="u_i_c_big' + file.id + '"><img src="'+file_full+ '" /></span>');
	...
	function add_thumb_box(file, $filelist_DIV){
		...
		var inner_html 		= '<span class="file-thumb-title-description" style="display:none">';
				inner_html 		+= '<span class="nm-file-thumb">';
				inner_html 		+= '<span class="u_i_c_thumb"></span>';
			    ...
			    inner_html		+= '<span class="nm-file-title-description">';
			    ...
			    inner_html 		+= '<span class="file-add-meta-data"></span>';
		    
		    	inner_html		+= '<span class="clear"></span>';
		    	
		    inner_html		+= '</span>';
			
			inner_html		+= '<span class="progress_bar"><span class="progress_bar_runner"></span><span class="progress_bar_number">(' + plupload.formatSize(file.size) + ')<span></span>';
