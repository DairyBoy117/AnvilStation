...
class sw_PopularWidget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(false, $name = esc_html__('SW Popular Posts', 'blackfyre'));
    }
...
<?php while ($pc->have_posts()) : $pc->the_post(); ?>
      ...
      <li><a rel="bookmark" href="<?php the_permalink(); ?>">		<div class="img">
					...
					<?php if(has_post_thumbnail()){
							...
							$image = blackfyre_aq_resize( $img_url, 368, 148, true ); //resize & crop img
							?>
...
/** @see WP_Widget::form */
    function form($instance) {
    	$defaults = array('title' => esc_html__('SW Popular Posts', 'blackfyre' ), 'cat'=> '', 'nopost' => '5');
