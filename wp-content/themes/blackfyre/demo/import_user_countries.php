<?php
$wpdb->query("DROP TABLE IF EXISTS {$table_prefix}user_countries");
$wpdb->query("CREATE TABLE IF NOT EXISTS `{$table_prefix}user_countries` (
...
INSERT INTO `{$table_prefix}user_countries` (`id_country`, `name`, `iso_code_2`, `iso_code_3`) VALUES
