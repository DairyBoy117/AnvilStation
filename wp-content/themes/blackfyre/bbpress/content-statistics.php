...
<dl>
	...
	<dt><?php esc_html_e( 'Registered Users', 'blackfyre' ); ?></dt>
	<dd>
		<strong><?php echo esc_html( $stats['user_count'] ); ?></strong>
	</dd>

	<dt><?php esc_html_e( 'Forums', 'blackfyre' ); ?></dt>
	<dd>
		<strong><?php echo esc_html( $stats['forum_count'] ); ?></strong>
	</dd>

	<dt><?php esc_html_e( 'Topics', 'blackfyre' ); ?></dt>
	<dd>
		<strong><?php echo esc_html( $stats['topic_count'] ); ?></strong>
	</dd>

	<dt><?php esc_html_e( 'Replies', 'blackfyre' ); ?></dt>
	<dd>
		<strong><?php echo esc_html( $stats['reply_count'] ); ?></strong>
	</dd>

	<dt><?php esc_html_e( 'Topic Tags', 'blackfyre' ); ?></dt>
	<dd>
	...
	<?php if ( !empty( $stats['empty_topic_tag_count'] ) ) : ?>
		...
		<dt><?php esc_html_e( 'Empty Topic Tags', 'blackfyre' ); ?></dt>
		<dd>
	...
	<?php if ( !empty( $stats['topic_count_hidden'] ) ) : ?>
		...
		<dt><?php esc_html_e( 'Hidden Topics', 'blackfyre' ); ?></dt>
		<dd>
			<strong>
	...
	<?php if ( !empty( $stats['reply_count_hidden'] ) ) : ?>
		...
		<dt><?php esc_html_e( 'Hidden Replies', 'blackfyre' ); ?></dt>
		<dd>
			<strong>
