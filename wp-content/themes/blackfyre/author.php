...
<div class="<?php if ( of_get_option('fullwidth') ) {  }else{ ?>container boxed<?php } ?> blog normal-page container-wrap">
  ...
  <div class="row">
    ...
    <div class="col-lg-8 col-md-8">
        ...
        $new_query->query('author='.$author.'&showposts='.$showposts.'&cat='.$category_id.'&paged='.$paged );
       ?>
	 ...
	 <div class="block-divider"></div>
        ...
        <div class="pagination">
            <ul>
              <li>
                <?php
            $additional_loop = new WP_Query('author='.$author.'&showposts='.$showposts.'&cat='.$category_id.'&paged='.$paged );
