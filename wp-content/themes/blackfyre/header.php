            ...
            ?>
                <div class="user-wrap <?php echo esc_attr($noclanclass); ?>">
                    ...
                    <a class="btns messages" data-original-title="<?php esc_html_e( 'View your messages', 'blackfyre' ); ?>" data-toggle="tooltip" href="<?php echo esc_url($link);?>">
                     ...
                     <?php    }?> </a>
                        <?php
                        	$friend_requests_count = bp_friend_get_total_requests_count();
                            echo '<a class="btns frireq" href="'.bp_loggedin_user_domain() . bp_get_friends_slug() . '/requests/">';
                            echo '<i class="fa fa-bell"></i>';
                            if($friend_requests_count) {
                                echo '<i class="msg_ntf">'.$friend_requests_count.'</i>';
                            }
                            echo '</a>';
                        ?>
                     <?php  } ?>
            ...
            <div id="mcTooltip" >
                ...
                <form name="LoginWithAjax_Form" id="LoginWithAjax_Form1" action="<?php  echo esc_url(wp_login_url()); ?>" method="post">
                    <div id="social_login" class="reg" >
                     ...
                     <?php } ?>
                <?php
                	if(is_plugin_active('super-socializer/super_socializer.php') && function_exists( 'the_champ_login_button' ) ){
