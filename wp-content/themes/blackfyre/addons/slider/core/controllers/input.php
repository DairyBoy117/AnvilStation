	...
	*/
	...
	function input_admin_head()
	{
		...
		$l10n = apply_filters( 'acf/input/admin_l10n', array(
			'core' => array(
				'expand_details' => esc_html__("Expand Details",'blackfyre'),
				'collapse_details' => esc_html__("Collapse Details",'blackfyre')
			),
			'validation' => array(
				'error' => esc_html__("Validation Failed. One or more fields below are required.",'blackfyre')
			)
		));
...
(function($) {
	...
	acf.wp_version = "<?php echo esc_attr($wp_version); ?>";
