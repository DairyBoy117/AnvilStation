...
class acf_field_image extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->name = 'image';
		$this->label = esc_html__("Image",'blackfyre');
		$this->category = esc_html__("Content",'blackfyre');
		$this->defaults = array(
			'save_format'	=>	'object',
		...
		$this->l10n = array(
			'select'		=>	esc_html__("Select Image",'blackfyre'),
			'edit'			=>	esc_html__("Edit Image",'blackfyre'),
			'update'		=>	esc_html__("Update Image",'blackfyre'),
			'uploadedTo'	=>	esc_html__("uploaded to this post",'blackfyre'),
		);
...
<div class="acf-image-uploader clearfix <?php echo esc_attr($o['class']); ?>" data-preview_size="<?php echo esc_attr($field['preview_size']); ?>" data-library="<?php echo esc_attr($field['library']); ?>" >
	...
	<div class="has-image">
		<div class="hover">
			<ul class="bl">
				<li><a class="acf-button-delete ir" href="#"><?php esc_html_e("Remove",'blackfyre'); ?></a></li>
				<li><a class="acf-button-edit ir" href="#"><?php esc_html_e("Edit",'blackfyre'); ?></a></li>
			</ul>
		</div>
		<img class="acf-image-image" src="<?php echo esc_url($o['url']); ?>" alt=""/>
	</div>
	<div class="no-image">
		<p><?php esc_html_e('No image selected','blackfyre'); ?> <input type="button" class="button add-image" value="<?php esc_html_e('Add Image','blackfyre'); ?>" />
	</div>
</div>
		<?php
	}
...
<tr class="field_option field_option_<?php echo esc_attr($this->name); ?>">
	<td class="label">
		<label><?php esc_html_e("Return Value",'blackfyre'); ?></label>
		<p><?php esc_html_e("Specify the returned value on front end",'blackfyre') ?></p>
	</td>
	<td>
		<?php
		do_action('acf/create_field', array(
			...
			'layout'	=>	'horizontal',
			'choices'	=> array(
				'object'	=>	esc_html__("Image Object",'blackfyre'),
				'url'		=>	esc_html__("Image URL",'blackfyre'),
				'id'		=>	esc_html__("Image ID",'blackfyre')
			)
		));
		?>
	</td>
...
<tr class="field_option field_option_<?php echo esc_attr($this->name); ?>">
	<td class="label">
		<label><?php esc_html_e("Preview Size",'blackfyre'); ?></label>
		<p><?php esc_html_e("Shown when entering data",'blackfyre') ?></p>
	</td>
	<td>
		<?php
...
<tr class="field_option field_option_<?php echo esc_attr($this->name); ?>">
	<td class="label">
		<label><?php esc_html_e("Library",'blackfyre'); ?></label>
		<p><?php esc_html_e("Limit the media library choice",'blackfyre') ?></p>
	</td>
	<td>
		<?php
		...
		do_action('acf/create_field', array(
			...
			'choices' 	=>	array(
				...
				'uploadedTo' => esc_html__('Uploaded to post', 'blackfyre')
			)
		));
