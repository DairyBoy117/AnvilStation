window.BlackfyreMultiPostThumbnails = {
    ...
    removeThumbnail: function(id, post_type, nonce){
	    jQuery.post(ajaxurl, {
		    ...
		    if ( str == '0' ) {
			    ...
			    BlackfyreMultiPostThumbnails.setThumbnailHTML(str, id, post_type);
		    }
	    }
	    );
    },
    ...
    setAsThumbnail: function(thumb_id, id, post_type, nonce){
	    ...
	    jQuery.post(ajaxurl, {
		    ...
		    if ( str == '0' ) {
			    ...
			    win.BlackfyreMultiPostThumbnails.setThumbnailID(thumb_id, id, post_type);
			    win.BlackfyreMultiPostThumbnails.setThumbnailHTML(str, id, post_type);
		    }
	    }
	    );
    }
